...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="<?=base_url('guru')?>">
            <img alt="Logo" src="<?=base_url('assets')?>/img/bawaslu.png" width="90px;" height="90px" />
        </a>
    </div>
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
            ...
            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                <div class="kt-aside__brand-logo">
                    <a href="<?=base_url('guru')?>">
                        <img alt="Logo" width="35px;" src="<?=base_url('assets')?>/img/bawaslu.png" />
                    </a>
                </div>
            </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($user as $u) {
                                                                ...
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td>
                                                                        <img class="rounded-circle" height="50px" width="50px" src="<?= base_url() . 'assets/profile_picture/' . $u->image; ?>">
                                                                    </td>
