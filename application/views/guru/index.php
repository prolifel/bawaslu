            ...
            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                <div class="kt-aside__brand-logo">
                    <a href="<?=base_url('guru')?>">
                        <img alt="Logo" width="35px;" height="35px" src="<?=base_url('assets')?>/img/bawaslu.png" />
                    </a>
                </div>
            </div>
                                        ...
                                        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- ">
                                            <ul class="kt-menu__nav ">
                                                <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a
                                                    ...
                                                    class="kt-menu__link-text">Kegiatan</span><i
                                                    ...
                                                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                                        <ul class="kt-menu__subnav">
                                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                                ...
                                                                class="kt-menu__link-text">Lihat Kegiatan</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                </ul>
                                                        ...
                                                        <a href="<?=base_url('guru/add_materi')?>" class="kt-notification__item">
                                                            ...
                                                            <div class="kt-notification__item-details">
                                                                ...
                                                                <div class="kt-notification__item-time">
                                                                    Lihat Kegiatan Bawaslu
                                                                </div>
                                                            </div>
                                                        </a> 
                                                        <div class="kt-notification__custom">
                                                            <a href="<?=base_url('welcome/logoutt')?>"
                                                    ...
                                                    <div class="kt-portlet__body">
                                                        <div class="kt-widget19__wrapper">
                                                            ...
                                                            <div class="kt-widget19__text">
                                                                Selamat datang di halaman guru Learnify, anda dapat menambah Kegiatan .
                                                                Dalam Kegiatan anda dapat memasukan video, dan deskripsi nya. Seemoga anda
                                                                dapat menikmati Learnify!, kontak Administrator jika terjadi masalah
                                                                apapun yang terkait upload Kegiatan. Terima kasih telah menggunakan
                                                                learnify!
                                                                <br>
                                                                Selamat Bekerja :)
                                                            </div>
                                                        ...
                                                        <div class="kt-widget19__action">
                                                            <a href="#" class="btn btn-sm btn-label-brand btn-bold">Data Kegiatan</a> 
                                                        </div>
                                                    </div>
                                                </div>
