					...
					<div class="">
						...
						<div class="card">
							...
							<div id="detail" class="card-body">
								<form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/tambah_divisi') ?>">
									<input type="hidden" name="id">
									<div class="form-row">
										<div class="form-group col-md-4">
											<label for="title">Nama Divisi</label>
											<input autocomplete="off" required type="text" id="title" name="title" class="form-control">
										</div>
									</div>
