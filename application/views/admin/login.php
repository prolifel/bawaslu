		...
		<section class="section">
			<div class="d-flex flex-wrap align-items-stretch">
				<div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
					<div class="p-4 m-3">
						<!-- Button admin -->
						<a href="<?= base_url('welcome/admin') ?>"> <img class="rounded mx-auto d-block mb-4" src="<?= base_url('assets/') ?>/img/bawaslu.png" alt="logo" width="150" class=" mb-5 mt-2"></a>
						...
						<a class="btn btn-block btn-outline-primary btn-lg btn-icon icon-right" href="<?= base_url('/welcome/user') ?>"> Login U/ User </a>
					</div>
				</div>
				<div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/login-bg.jpg">
					<div class="absolute-bottom-left index-2">
						<div class="text-light p-5 pb-2">
							...
							Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb" target="_blank" href="https://github.com/saifull19">Saiful Anam</a> - Image by <a class="text-light bb" target="_blank" href="https://unsplash.com">Unsplash</a>
						</div>
					</div>
				</div>
			</div>
