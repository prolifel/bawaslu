				...
				<section class="section">
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Update Data User</h2>
								<hr>
								<p class="card-text"> Update data user meliputi Email dan Nama Lengkap.
									Kita tidak bisa mengubah password User, Hanya user yang dapat mengubah passwordnya
									sendiri.
								</p>
					...
					<div class="card">
						...
						<?php foreach ($user as $u) { ?>
							<div class="card-body">
								<form method="POST" action="<?= base_url('admin/kegiatan_edit') ?>">
									<input hidden id="id" type="text" class="form-control" value="<?= $u->id ?>" name="id">

									<div class="form-group">
										<label for="nama">Nama Lengkap</label>
										<input id="nama" type="text" class="form-control" name="nama" value="<?= $u->nama ?>">
									...
									<div id="" class="form-group">
										...
										<input id="telepon" type="text" class="form-control" name="telepon" value="<?= $u->telepon ?>">
									...
									<div id="" class="row">
										<div class="form-group col-12">
											...
											<select class="form-control selectric" name="divisi">
												...
												<option value="Other" <?php if($u->divisi == 'Other') echo "selected"?>>Other</option>
												<option value="Koordinator" <?php if($u->divisi == 'Koordinator') echo "selected"?>>Koordinator</option>
												<option value="Humas" <?php if($u->divisi == 'Humas') echo "selected"?>>Humas</option>
											</select>
