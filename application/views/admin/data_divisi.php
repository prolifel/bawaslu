				...
				<section class="section">
					<div class="card" style="width:100%;">
						<div class="card-body">
							...
							<a href="<?= base_url('admin/tambah_divisi') ?>" class="btn btn-success">Tambah
							Data Divisi ⭢</a>
						</div>
					</div>
					<div class="row">
											...
											foreach ($user as $u) {
												...
												<tr class="text-center">
													...
													<td class="text-center">
														<a href="<?php echo site_url('admin/update_divisi/' . $u->id); ?>" class="btn btn-info">Update ⭢</a>

														<a href="<?php echo site_url('admin/delete_divisi/' . $u->id); ?>" class="btn btn-danger remove">Delete ✖</a>
													</td>
